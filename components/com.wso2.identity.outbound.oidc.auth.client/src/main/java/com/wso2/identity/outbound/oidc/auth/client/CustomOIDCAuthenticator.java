...
import com.wso2.identity.outbound.oidc.auth.client.constants.CustomOIDCAuthenticatorConstants;
...
public class CustomOIDCAuthenticator extends AbstractApplicationAuthenticator
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            com.wso2.identity.outbound.oidc.auth.service.rpc.AuthenticationContext authenticationContext
                    = com.wso2.identity.outbound.oidc.auth.service.rpc.AuthenticationContext.newBuilder()
